...
function handleDescriptionToggle(roomId, showLess = false) {
  const shortDesc = document.getElementById(`desc-${roomId}`);
  const fullDesc = document.getElementById(`desc-full-${roomId}`);
